...
import { _NameForms, _NameTable } from "./_namespace.forms";
...
import { CreateUpdateComponent } from "src/app/base/components/create-update-modal/create-update-modal.component";
...
export class _NamePage implements OnInit {
  ...
  openModalCreateUpdateItem(id: string, type: string) {
    ...
    if (item) {
      ...
      modalRef.componentInstance.router = '_name';
      modalRef.componentInstance.formFields = _NameForms;
